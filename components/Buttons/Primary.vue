 ...
 <template> 
    <button
      :type="type" 
      :class="[
        'py-1 px-2   group justify-center flex b text-white  duration-500 ease-in-out rounded-md  active:bg-primary outline-none hover:bg-opacity-70 bg-primary',
        { 'zoom-animation': isClicked },
        loading ? 'bg-primary text-white' : '',width === 'full' ? 'w-full' : 'fit', 
      ]"
